    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h4 class="mb-0 text-red">{{ __('Campos requeridos') }} *</h4>
                <div class="col">
                    <div class="form-group">
                        ...
                        <div class="input-group input-group-alternative">
                            ...
                            <input type="text" id="menu_name" name="save_new_menu_name" class="form-control"
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <div class="input-group input-group-alternative">
                            ...
                            <textarea type="text" id="menu_description" name="save_new_menu_description"
                                class="form-control" placeholder="{{ __('Descripción') }}"></textarea>
                        </div>
                    </div>
                </div>
                <div class="col alert alert-success">
                    <p class="description" style="color: black">
                        {{ __('Al guardar el menú, serás redireccionado a los menús disponibles del paciente') }}</p>
                </div>
                <div class="col">
                    <button id="save_menu_btn" class="btn btn-success btn-block"><i class="ni ni-folder-17"></i>
                        {{ __('Guardar') }}</button>
                </div>
            </div>
        </div>
