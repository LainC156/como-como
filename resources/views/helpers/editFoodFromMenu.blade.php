...
<div class="modal fade" id="editMenuComponentModal" tabindex="-1" role="dialog" aria-labelledby="editComponentMenuModal" aria-hidden="true">
                                ...
                                <div class="col-auto">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-alternative">
                                            ...
                                            <input  type="text" id="menuComponentNameEdited" name="edit_component_name" class="form-control" disabled >
                                        </div>
                                    </div>
                                </div>
                                    <!-- food weight -->
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-alternative">
                                            ...
                                            <input type="number" id="menuComponentFoodWeightEdited" name="edit_component_amount" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                                <!-- kind of food -->
