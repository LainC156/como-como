...
@section('content')
    ...
    <div class="container-fluid mt--7">
                            ...
                            <div class="card card-stats mb-4 mb-xl-0">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-6">
                                            <!-- MACRONUTRIENTS -->
                                            <h5 class="card-title text-uppercase mb-0 text-center text-primary">{{ __('Macronutrientes') }}</h5>
                                            <div class="table-responsive">
                                                ...
                                                <table class="table align-items-center table-flush table-sm table-striped">
                                                    <thead class="thead-light">
                                                        <tr>
                                                            ...
                                                            <th scope="col">{{ __('Total') }} ({{ __('kcal') }}.)</th>
                                                            <th scope="col">{{ __('Estado') }}</th>
                                                            <th scope="col">{{ __('Valor mín.') }} ({{ __('kcal') }}.)</th>
                                                            <th scope="col">{{ __('Valor máx.') }} ({{ __('kcal') }}.)</th>
                                                        </tr>
                                                    </thead>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @elseif( $result->carbohydratesStatus == 1 )
                                                            <tr id="carbNorm">
                                                        @endif
                                                            <td><p> <span class="h5 font-weight-bold mb-0">{{ __('Carbohidratos') }}</span> </p></td>
                                                            <td>{!! $result->carbohydrates !!}</td>
                                                        @if( $result->carbohydratesStatus == 0 )
                                                            <td class="text-warning"><i class="fas fa-exclamation-circle"></i>{{ __('Deficiente') }}</td>
                                                        @elseif( $result->carbohydratesStatus == 2  )
                                                            <td class="text-danger"><i class="fas fa-exclamation-circle"></i>{{ __('Excedente') }}</td>
                                                        @elseif( $result->carbohydratesStatus == 1 )
                                                            <td class="text-success"><i class="fas fa-exclamation-check"></i>{{ __('Bueno') }}</td>
                                                        @endif
                                                        ...
                                                        @elseif( $result->proteinsStatus == 1 )
                                                            <tr id="protNorm">
                                                        @endif
                                                        <td><p> <span class="h5 font-weight-bold mb-0">{{ __('Proteínas') }}</span> </p></td>
                                                        ...
                                                        @elseif( $result->lipidsStatus == 1 )
                                                            <tr id="lipNorm">
                                                        @endif
                                                        <td><p> <span class="h5 font-weight-bold mb-0">{{ __('Lípidos') }}</span> </p></td>
                                                        <td>{!! $result->lipids !!}</td>
                                                            @if( $result->lipidsStatus == 0 )
                                                                <td class="text-warning"><i class="fas fa-exclamation-circle"></i>{{ __('Deficiente') }}</td>
                                                            @elseif( $result->lipidsStatus == 2 )
                                                                <td class="text-danger"><i class="fas fa-exclamation-circle"></i>{{ __('Excedente') }}</td>
                                                            @elseif( $result->lipidsStatus == 1 )
                                                                <td class="text-success"><i class="fas fa-check"></i>{{ __('Bueno') }}</td>
                                                            @endif
                                                ...
                                                <div class="col-6">
                                                    <!-- MICRONUTRIENTS -->
                                                    <h5 class="card-title text-uppercase mb-0 text-center text-info">{{ __('Micronutrientes') }}</h5>
                                                    <div class="table-responsive">
                                                        <table class="table align-items-center table-flush table-sm table-striped">
                                                            <thead class="thead-light">
                                                                    <th scope="col">{{ __('Componente') }}</th>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                @endif
                                                                <td><p> <span class="h5 font-weight-bold mb-0">{{ __('Calcio') }}</span> </p></td>
                                                                ...
                                                                @endif
                                                                <td><p> <span class="h5 font-weight-bold mb-0">{{ __('Fósforo') }}</span> </p></td>
                                                                ...
                                                                @endif
                                                                <td><p> <span class="h5 font-weight-bold mb-0">{{ __('Hierro') }}</span> </p></td>
                                                                ...
                                                                @endif
                                                                        <td><p> <span class="h5 font-weight-bold mb-0">{{ __('Magnesio') }}</span> </p></td>
                                                                ...
                                                                @endif
                                                                        <td><p> <span class="h5 font-weight-bold mb-0">{{ __('Sodio') }}</span> </p></td>
                                                                ...
                                                                @endif
                                                                        <td><p> <span class="h5 font-weight-bold mb-0">{{ __('Potasio') }}</span> </p></td>
                                                                ...
                                                                @endif
                                                                        <td><p> <span class="h5 font-weight-bold mb-0">{{ __('Zinc') }}</span> </p></td>
                                                                ...
                                                                @endif
                                                                        <td><p> <span class="h5 font-weight-bold mb-0">{{ __('Vitamina A') }}</span> </p></td>
                                                                ...
                                                                @endif
                                                                        <td><p> <span class="h5 font-weight-bold mb-0">{{ __('Vitamina B1') }}</span> </p></td>
                                                                ...
                                                                @endif
                                                                        <td><p> <span class="h5 font-weight-bold mb-0">{{ __('Vitamina B2') }}</span> </p></td>
                                                                ...
                                                                @endif
                                                                        <td><p> <span class="h5 font-weight-bold mb-0">{{ __('Vitamina B3') }}</span> </p></td>
                                                                ...
                                                                @endif
                                                                        <td><p> <span class="h5 font-weight-bold mb-0">{{ __('Vitamina B6') }}</span> </p></td>
                                                                ...
                                                                @endif
                                                                        <td><p> <span class="h5 font-weight-bold mb-0">{{ __('Vitamina B9') }}</span> </p></td>
                                                                ...
                                                                @endif
                                                                        <td><p> <span class="h5 font-weight-bold mb-0">{{ __('Vitamina B12') }}</span> </p></td>
                                                                ...
                                                                @endif
                                                                        <td><p> <span class="h5 font-weight-bold mb-0">{{ __('Vitamina C') }}</span> </p></td>
        ...
        <div class="modal fade" id="recomendationsModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-bg modal-dialog " role="document">
                ...
                <div class="modal-footer">
                    ...
                    <div class="row">
                        ...
                        <button id="copy_to_clipboard" type="button" class="btn btn-primary">{{ __('Copiar al portapapeles') }}</button>
                    </div>
                </div>
            </div>
        </div>
