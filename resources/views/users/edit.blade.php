@extends('layouts.app')
@section('title')
    {{ __('Editar paciente') }} | {{ __('¿Cómo como?') }}
@endsection
@section('content')
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-6 text-right">
                                <a href="{{ route('user.index') }}" class="btn btn-sm btn-primary"
                                    target="_blank"><i class="fa fa-users"></i> {{ __('Pacientes registrados') }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="pl-lg-4">
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="form-control-label"
                                                            ...
                                                            <span id="name_required" style="color: red;">*</span></label>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="form-control-label"
                                                            for="input_last_name">{{ __('Apellidos') }} <span
                                                                id="last_name_required" style="color: red;">*</span>
                                                        </label>
                                                        <input type="text" name="input_last_name" id="input_last_name"
                                                            class="form-control form-control-alternative"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        <label class="form-control-label "
                                                            ...
                                                            <span id="weight_required" style="color: red;">*</span>
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        <label class="form-control-label"
                                                            ...
                                                            <span id="height_required" style="color: red;">*</span>
                                                ...
                                                <div class="col">
                                                    <label class="form-control-label"
                                                        ...
                                                        <span id="birthdate_required" style="color: red;">*</span>
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        <label class="form-control-label"
                                                            ...
                                                            <span id="genre_required" style="color: red;">*</span>
                                                ...
                                                <div class="col">
                                                    <div class="form-group">
                                                        <label class="form-control-label"
                                                            ...
                                                            <span id="psychical_activity_required" style="color: red;">*</span>
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="form-group">
                                                            ...
                                                            <span id="caloric_requirement_required"
                                                                class="text-red">*</span>
                                                            <div class="row">
                                                                <div class="col">
                                                                    <div class="custom-control custom-radio mb-3">
                                                                        <input name="custom-radio-1"
                                                                            ...
                                                                            id="automatic_calculation" type="radio" @if ($patient->acrc) checked @endif>
                                                                ...
                                                                <div class="col">
                                                                    <div class="custom-control custom-radio mb-3">
                                                                        <input name="custom-radio-1"
                                                                            class="custom-control-input"
                                                                            id="custom_calculation" type="radio" @if (!$patient->acrc) checked @endif>
                                                                        <label class="custom-control-label"
                                                            ...
                                                            <div class="row">
                                                                <div class="col">
                                                                    <input type="number" name="input_caloric_requirement"
                                                                        ...
                                                                        value="{!! $patient->caloric_requirement !!}"
                                                                        class="form-control form-control-alternative">
                                                                </div>
                                                            </div>
                                                        </div>
                            ...
                            <div class="text-center">
                                ...
                                <button id="update_user_btn" type="submit"
                                    class="btn btn-success mt-4"><i class="fa fa-user-plus"></i> {{ __('Actualizar usuario') }}</button>
                            </div>
                        </div>
                    </div>
                </div>
