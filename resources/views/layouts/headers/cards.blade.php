                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <h5 class="card-title text-uppercase text-muted mb-0">
                                            {{ __('Estado de la cuenta') }}:</h5>
                                        @if ($user->trial_version_status)
                                            <span
                                                class="h2 font-weight-bold mb-0">{{ __('Versión de prueba') }}</span>
                                        @elseif( $user->subscription_status == 1 && !$user->nutritionist_id)
                                            <span
                                                class="h2 font-weight-bold mb-0">{{ __('Suscripción mensual') }}</span>
                                        @elseif($user->nutritionist_id && $user->subscription_status == 1)
                                            <span
                                                class="h2 font-weight-bold mb-0">{{ __('Esta cuenta fue creada por tu nutriólogo, solo puedes ver tus recordatorios') }}</span>
                                        @endif
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                @if (($user->subscription_status == 1 && !$user->nutritionist_id) || ($user->trial_version_status && !$user->nutritionist_id))
                                    <p class="mt-3 mb-0 text-muted text-sm">
                                        ...
                                        <a href="{{ route('profile.edit', auth()->user()->id) }}"><span
                                                class="text-nowrap">{{ __('Editar perfil') }}</span></a>
                                    </p>
                                @endif
                            </div>
                        </div>
                                ...
                                @if ($user->subscription_status == 1 && !$user->nutritionist_id)
                                    <p class="mt-3 mb-0 text-muted text-sm">
                                        <span class="text-warning mr-2"><i class="fas fa-arrow-down"></i>
                                            {{ __('¿Necesitas un nuevo menú?') }}</span>
                            ...
                            <div class="card card-stats mb-4 mb-xl-0">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <h5 class="card-title text-uppercase text-muted mb-0">{{ __('Social') }}
                                            </h5>
                                            <span
                                                class="h2 font-weight-bold mb-0">{{ __('¿A quién le gusta tu menú?') }}</span>
                                        </div>
                                    </div>
                                    <p class="mt-3 mb-0 text-muted text-sm">
                                        <span class="text-success mr-2"><i class="fas fa-arrow-up"></i>
                                            {{ __('¿Qué dicen los usuarios de tus menús?') }}</span>
