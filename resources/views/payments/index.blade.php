                    ...
                    <div class="card-body">
                        ...
                        <div class="container">
                            @if ($user->trial_version_status === true)
                                ...
                                <h5 class="display-4 text-warning text-center">{{ __('La versión de prueba caduca el') }}
                                    {!! date(' j - m - Y', strtotime($user->expiration_date)) !!}</h5>
                                    ...
                                    <ul class="nav nav-pills nav-fill flex-column flex-md-row" id="tabs-icons-text"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link mb-sm-3 mb-md-0" id="tabs-icons-text-4-tab" data-toggle="tab"
                                                ...
                                                aria-selected="false"><i class="fab fa-cc-paypal fa-2x"></i>
                                                {{ __('Paypal') }}</a>
                                        </li>
                                    </ul>
                                </div>
