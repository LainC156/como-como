                ...
                <div class="col-xl-12">
                    <div class="card card-stats mb-4 mb-xl-0">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-1">
                                    <i id="remove_data" class="fas fa-trash">{{ __('Limpiar campos') }}</i>
                                </div>
                                    <div class="col-md-4">
                                        <input class="form-control" type="text" id="food_name" disabled placeholder="{{ __('Nombre(selecciona algún alimento de la tabla)') }}">
                                    </div>
                                    <div class="col-md-2">
                                        <input class="form-control" type="number" id="food_amount" placeholder="{{ __('Cantidad') }}">
                                    </div>
                                    <div class="col-md-2">
