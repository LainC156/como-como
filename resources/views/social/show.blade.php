                        ...
                        <div class="row">
                            <div class="col">
                                <div class="card bg-dark border-primary">
                                    ...
                                    <div class="card-body bg-secondary" data-toggle="tooltip" data-placement="bottom"
                                        title="{{ __('Da clic sobre esta área para acceder al menú') }}">
                                        <a href="{{ route('menu.show', ['id' => $menu->id]) }}" target="_blank">
                                            <div class="row">
                                                <div class="col-auto">
                                                    <span
                                                        class="description text-muted text-default">{{ __('Nombre del menú') }}:
                                                        <strong class="text-primary">{!! $menu->name !!}</strong></span>
                                                </div>
                                                <div class="col-auto col-6">
                                                    <span
                                                        class="description text-muted text-default">{{ __('Descripción') }}:
                                                        <strong class="text-primary">{!! $menu->description !!}</strong></span>
                                                </div>
                                                @if ($patient->age)
                                                    <div class="col-auto">
                                                        <span
                                                            class="description text-muted text-default">{{ __('Edad') }}:
                                                            <strong class="text-primary">{!! $patient->age !!}
                                                                {{ __('años') }}</strong></span>
                                                    </div>
                                                @endif
                                                <div class="col-auto">
                                                    <span
                                                        class="description text-muted text-default">{{ __('Requerimiento calórico') }}:
                                                        <strong class="text-primary">{!! $patient->caloric_requirement !!}
                                                            {{ __('kcal') }}.</strong></span>
                                                </div>
                                                @if ($patient->weight)
                                                    <div class="col-auto">
                                                        <span
                                                            class="description text-muted text-default">{{ __('Peso') }}:
                                                            <strong class="text-primary">{!! $patient->weight !!}
                                                                {{ __('kg') }}.</strong></span>
                                                    </div>
                                                @endif
                                                @if ($patient->height)
                                                    <div class="col-auto">
                                                        <span
                                                            class="description text-muted text-default">{{ __('Estatura') }}:
                                                            <strong class="text-primary">{!! $patient->height !!}
                                                                {{ __('cm') }}.</strong></span>
                                                    </div>
                                                @endif
                                                @if ($patient->genre === '0' || $patient->genre === '1')
                                                    <div class="col-auto">
                                                        <span
                                                            class="description text-muted text-default">{{ __('Género') }}:
                                                ...
                                                <div class="col-auto">
                                                    @if ($patient->psychical_activity == 0)
                                                        <span
                                                            class="description text-muted text-default">{{ __('Tipo de actividad física') }}:
                                                            <strong
                                                ...
                                                <div class="col-auto">
                                                    @if ($patient->ideal == 0)
                                                        <span class="description text-muted">{{ __('Estado') }}: <strong
                                            ...
                                            <div class="col-xl-12 col-md-12 co-md-12 col-md-offset-2 col-sm-12">
                                                <div class="card border-info">
                                                    <div class="card-header bg-light">
                                                        <div class="row">
                                                            <div class="col-auto">
                                                                <button style="display: none;" id="btn_like"
                                                                    class="btn text-default btn-block text-warning"
                                                                    data-toggle="tooltip" data-placement="top"
                                                                    title="{{ __('Da clic para indicar que te gusta este menú') }}">

                                                                </button>
                                                                <button style="display: none;" id="btn_no_like"
                                                                    class="btn btn-block btn-block text-red"
                                                                    data-toggle="tooltip" data-placement="top"
                                                                    title="{{ __('Has indicado que te gusta este menú') }}">
                                                                </button>
                                                            </div>
                                                            <div class="col-auto">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-auto col-sm-8 col-md-8 col-lg-8">
                                                                <textarea class="form-control" id="input_comment"
                                                                    name="comment_input"
                                                                    placeholder="{{ __('¿Qué te pareció este menú?') }}"
                                                                    rows="2"></textarea>
                                                            </div>
                                                            <div class="col-auto col-sm-4 col-md-4 col-lg-4">
                                                                <button id="btn_post_comment" class="btn btn-primary"><i
                                                                        class="fa fa-plus" aria-hidden="true"></i>
                                                                    {{ __('Publicar comentario') }}</button>
                                                            </div>
                                                        </div>
                                                        <div class="my-1"></div>
                                                        <div class="row">
                                                            <div class="col" id="social_comments">
                                                                @forelse ($activities as $activity)
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-auto">
                                                                                    <span
                                                                                        ...
                                                                                        <img src="{{ asset('img/avatar/' . $activity->avatar) }}"
                                                                                    ...
                                                                                    <div class="col-auto">
                                                                                        <span class="text-muted pull-right">
                                                                                            <small class="text-muted">
                                                                                                {!! date('d-m-Y\\, h:i:s A', strtotime($activity->created_at)) !!}</small>
                                                                                        </span>
                                                                                    </div>
                                                                                </div>
                                                                                <div
                                                                                    class="col-md-12 col-lg-6 col-md-12 col-sm-12 w-50 align-self-end description text-dark alert alert-light rounded">
                                                                                    {!! $activity->comment !!}
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="my-1"></div>
                                                                @empty
                                                                    <h5 id="no_comments_header"
                                                                        class="description text-muted">
                                                                        {{ __('Sin comentarios disponibles') }}</h5>
                                                                @endforelse
                                                            </div>
                                                        </div>
                                                    </div>
...
<script>
    $(document).ready(function() {
        ...
        if (like == 1) {
            msg = '<i class="fas fa-heart text-red"></i>' + " " + like_count + " " +
                "{{ __('Te gusta este menú') }}";
        ...
        $("#btn_no_like").click(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    like_count -= 1;
                    $("#btn_no_like").hide();
                    msg = '<i class="fas fa-heart text-info"></i>' + " " + like_count +
                        " " + "{{ __('Me gusta') }}";
                    $("#btn_like").html(msg);
                    $("#btn_like").show();
                },
                    ...
                    if (data.kind_of_comment == 'new' || data.kind_of_comment ==
                        ...
                        $("#social_comments")
                            .append('<div class="card bg-light"> ' +
                                ...
                                '<div class="col-auto">' +
                                ' <span class="avatar avatar rounded-circle"> ' +
                                ' <img id="avatar_img" src="{{ asset('img/avatar') }}/' +
                                av + '" alt="" class="img-circle"> ' +
                                ' </span>' +
                                '</div>' +
                                ' <div class="col-auto">' +
                                '<div class="col-auto">' +
                                '<strong class="text-success">@ ' + user_name + ' ' +
                                last_name + '</strong>' +
                                '</div>' +
                                ' <div class="col-auto">' +
                                '<span class="text-muted pull-right">' +
